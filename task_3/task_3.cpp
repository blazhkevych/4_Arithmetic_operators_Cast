...
int main()
{
	...
	int start_of_conversation_s = start_of_conversation_h % 100; //145512%100=12
	...
	int end_of_conversation_s = end_of_conversation_h % 100; //152056%100=56
	...
	//((15*60*60)+(20*60)+56)-((14*60*60)+(55*60)+12)=54136-53712=424

	const double cost_of_a_minute = 30;

	double total_cost = (call_duration_in_seconds * cost_of_a_minute) / 100;
